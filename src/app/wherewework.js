  ...
  return (
    ...
    >
      <motion.div
        ...
        variants={fadeUp}
        className="font-sans mt-20 max-w-7xl mx-auto rounded-2xl shadow-xl overflow-hidden bg-white"
      >
        <div className="grid lg:grid-cols-2 items-center bg-gradient-to-br from-gray-50 to-white">
          {/* LEFT TEXT SECTION */}
          <motion.div
            variants={stagger}
            className="max-lg:order-1 max-lg:text-center sm:p-12 p-6"
          >
            <motion.h2
              variants={fadeUp}
              className="text-orange-red lg:text-5xl text-3xl font-bold lg:leading-[56px]"
            >
              Where We Work.
            </motion.h2>
            ...
            <motion.p
              variants={fadeUp}
              className="text-gray-800 mt-6 text-base leading-relaxed"
            >
              Leki Charity Foundation operates nationwide but primarily in the
              Northern region of Uganda, an area historically affected by
              conflict and socio-economic challenges.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-gray-800 mt-6 text-base leading-relaxed"
            >
              Our efforts focus on rural and underserved communities where
              access to education remains limited. By collaborating with parents
              and local leaders, we reach the most vulnerable children and help
              them thrive academically.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-gray-800 mt-6 text-base leading-relaxed"
            >
              We believe education is the key to breaking generational poverty.
              As we grow, our goal is to expand our reach and empower more young
              people with opportunities for a better future.
            </motion.p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: false, amount: 0.3 }}
            className="lg:h-[480px] flex items-center relative"
          >
            <motion.div
              animate={{ y: [0, -10, 0] }}
              transition={{
            ...
            >
              <Image
                src={map}
                className="w-full h-full object-cover hidden md:block rounded-l-xl"
                alt="Map of Uganda showing regions we work in"
              />
            </motion.div>
          </motion.div>
        </div>

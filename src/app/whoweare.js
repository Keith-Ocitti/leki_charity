...
function WhoWeAre({ whoWeAreRef }) {
  return (
    <div
      className="font-sans mt-20 scroll-mt-24 px-4 md:px-10"
      tabIndex="-1"
      ref={whoWeAreRef}
      id="who-we-are"
    >
      <div className="max-w-7xl mx-auto rounded-2xl shadow-lg overflow-hidden grid lg:grid-cols-2 items-center lg:gap-y-6 bg-gradient-to-br from-gray-50 to-white">
        ...
        <div className="lg:h-[480px] flex items-center">
          <Image
            ...
            alt="Children in school supported by Leki Charity"
          />
        </div>
      </div>

      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-6 px-4 md:px-0 mt-20 my-12 max-w-7xl mx-auto">
        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
          <h3 className="text-lg font-bold mb-2 text-orange-red">
            Our Mission
          </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
          <h3 className="text-lg font-bold mb-2 text-orange-red">Our Values</h3>
          <p className="text-sm text-black">

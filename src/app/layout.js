...
export const metadata = {
	title: "Leki Charity Foundation",
	description: "Developed by keith ocitti",
};
	...
	return (
		<html lang="en">
			...
			>
				...
				<footer class="bg-gray-700 py-10 px-10 font-sans tracking-wide">
					...
					<ul class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-3 gap-12 mt-20">
